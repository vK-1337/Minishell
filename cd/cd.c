...
/*   Updated: 2024/03/11 03:11:53 by vda-conc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_cd_path_find(char *path, t_list **env)
{
	...
	cd_path = ft_find_var(env, "$CDPATH");
	if (cd_path == NULL || cd_path->content == NULL)
		return (-1);
	cdpath_split = ft_split(cd_path->content, ':');
	i = 0;
